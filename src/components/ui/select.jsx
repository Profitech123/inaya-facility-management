    ...
    return (
      <SelectPrimitive.Portal>
        ...
        <SelectPrimitive.Content
          ref={ref}
          className={cn(
            "z-50 max-h-[70vh] w-full overflow-y-auto rounded-t-xl border bg-popover text-popover-foreground shadow-lg",
            "!fixed !inset-x-0 !bottom-0 !top-auto !left-0 !transform-none !min-w-0",
