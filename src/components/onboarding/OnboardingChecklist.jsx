...
const ICON_MAP = { Search: MagnifyingGlass, Home: House, CalendarPlus, Package: PhPackage, ClipboardList: ClipboardText, LayoutDashboard: SquaresFour, CalendarCheck, LifeBuoy: Lifebuoy, TrendingUp: ChartLineUp, Users: UsersThree };
