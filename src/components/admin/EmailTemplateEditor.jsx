      ...
      <div>
        ...
        {previewMode ? (
          <div className="border rounded-lg overflow-hidden bg-slate-100">
            <div className="flex items-center gap-2 px-4 py-2 bg-slate-800 text-slate-300 text-xs">
              ...
              <span className="flex-1 text-center text-slate-400">Email Preview — Sample Data</span>
            </div>
            <iframe
              srcDoc={`<!DOCTYPE html><html><head><meta charset="utf-8"/><meta name="viewport" content="width=device-width"/></head><body style="margin:0;padding:0;">${getPreviewHtml()}</body></html>`}
              className="w-full"
