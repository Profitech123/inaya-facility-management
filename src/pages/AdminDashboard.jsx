...
function AdminDashboardContent() {
  ...
  const kpis = [
    ...
    { label: 'Services', value: services.length, sub: `${services.filter(s => s.is_active).length} active`, icon: ChartLineUp, color: 'text-rose-600', bg: 'bg-rose-50' },
          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-2 gap-2">
              {[
                ...
                { label: 'Invoices', page: 'AdminInvoices' },
                { label: 'Service Areas', page: 'AdminServiceAreas' },
